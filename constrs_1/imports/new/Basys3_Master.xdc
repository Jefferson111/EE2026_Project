...
set_property PACKAGE_PIN V16 [get_ports {Menu_Sw}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Menu_Sw}]
set_property PACKAGE_PIN W16 [get_ports {Cursor_Sw}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Cursor_Sw}]
set_property PACKAGE_PIN W17 [get_ports {Trigger_Sw}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Trigger_Sw}]
set_property PACKAGE_PIN W15 [get_ports {Scrolling_Sw}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Scrolling_Sw}]
#set_property PACKAGE_PIN V15 [get_ports {Scrolling_Sw}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {Scrolling_Sw}]
...
set_property PACKAGE_PIN T1 [get_ports {SW3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SW3}]
set_property PACKAGE_PIN R2 [get_ports {temp_sw}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {temp_sw}]
